        ...
        <div class="contenu">
            <div class="activContainer">
                <form class="edu">
                    ...
                    <input nom="start" type="date" />

                    <label>Date de fin</label>
                    <input nom="fin" type="date" />

                    <label>Facteur d'impacte</label>
                    <input nom="factor" type="number" />

                    <label>Fonction éditoriale</label>
                    <select name="funcEd" id="funcEd">
