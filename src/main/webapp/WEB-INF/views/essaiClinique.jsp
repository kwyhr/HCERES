    ...
    <body>
        ...
        <div class="contenu">
            <div class="activContainer">
                <form class="edu essaiClq">
                    <label>Chercheur</label>
                    <select name="chercheur" id="chercheur">
                        <option value="">Choisir le nom du chercheur</option>
                    </select>

                    <label>Date de début</label>
                    <input nom="dateDebut" type="date" />

                    <label>Titre de l'essai</label>
                    <input nom="titre" type="text" />

                    <label>Date de fin</label>
                    <input nom="dateFin" type="date" />

                    <label>Numéro de registration</label>
                    <input nom="numReg" type="text" />

                    <label>Sponsor</label>
                    <input nom="spon" type="text" />

                    <label>Numéro de patients dans l'essai</label>
                    <input nom="nbpas" type="text" />

                    <label>Le financement</label>
                    <input nom="finan" type="text" />

                    <label>Le montant financement</label>
                    <input nom="finanMont" type="number" />
                </form>
            </div>
        </div>
        <div class="footer">
