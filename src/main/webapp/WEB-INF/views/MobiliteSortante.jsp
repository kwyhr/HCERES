    ...
    <body>
        ...
        <div class="contenu">
            <div class="activContainer">
                <form class="edu incomingMob">
                    <label>Scientifique senior</label>
                    <input nom="seniorSc" type="text" />

                    <label>Date d'arrivé</label>
                    <input nom="arriv" type="date" />

                    <label>Date de départ</label>
                    <input nom="depart" type="date" />

                    <label>Durée</label>
                    <input nom="duree" type="number" />

                    <label>Laboratoire d'acceuil</label>
                    <input nom="labName" type="text" />

                    <label>Location de laboratoire</label>
                    <input nom="labLoc" type="text" />

                    <label>Titre du projet</label>
                    <input nom="nbpas" type="text" />

                    <label>Le financement</label>
                    <input nom="finan" type="text" />

                    <label>Nombre de publications</label>
                    <input nom="pubNb" type="number" />

                    <label>Publication de référence</label>
                    <input nom="pubref" type="text" />
                </form>
            </div>
        </div>
        <div class="footer">
