        ...
        <div class="contenu">
            <div class="activContainer">
                <form class="edu exper">
                    ...
                    <select name="typeExpert" id="typeExpert">
                        <option value="null">Choisir le type d'expertise</option>
                    </select>
                    ...
                    <textarea nom="description" type="text"></textarea>
                </form>
            </div>
        </div>
        <div class="footer">
