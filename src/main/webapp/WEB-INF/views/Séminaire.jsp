    ...
    <body>
        ...
        <div class="contenu">
            <div class="activContainer">
                <form class="edu seminaire">
                    <label>Chercheur</label>
                    <select name="chercheur" id="chercheur">
                        <option value="">Choisir le nom du chercheur</option>
                    </select>

                    <label>Titre de séminaire</label>
                    <input name="titre"></input>

                    <label>Date de séminaire</label>
                    <input nom="dateSem" type="text" />

                    <label>Location</label>
                    <input nom="location" type="text" />

                    <label>Invité par :</label>
                    <input nom="invitePar" type="text" />
                </form>
            </div>
        </div>
        <div class="footer">
