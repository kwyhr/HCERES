        ...
        <div class="contenu">
            <div class="activContainer">
                <form class="edu indus">
                    ...
                    <select name="typeCollab" id="typeCollab">
                        <option value="null">Choisir le type de collaboration</option>
                    </select>
                    ...
                    <input nom="partner" type="text" />

                    <label>Ville - Région - Pays</label>
                    <input nom="vrp" type="text" />

                    <label>Mail de partenaire</label>
                    <input nom="mailPart" type="email" />

                    <label>Titre de projet</label>
                    <input nom="titreProj" type="text" />
                </form>
            </div>
        </div>
        <div class="footer">
